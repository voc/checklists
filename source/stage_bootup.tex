...
\begin{checklist}{Lectern}
  ...
  \item{Slides from Laptop}{operational}
    \hint{connect own laptop, select input on ATEM, observe image on Projector}
  \item{Audio from Laptop}{operational}
    \hint{connect own laptop, play music, listen on Audio mixer, PA and recording}
\end{checklist}
...
\begin{checklist}{Sync Check}
  ...
  \item{Audio/Video Sync}{observe}
    \hint{listen to livestream, watch for sync of hands touching and clap in audio}
  \item{Restart voctocore}{as needed}
    \hint{systemctl restart voctomix2-voctocore}
